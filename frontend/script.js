...
const TRANSLATIONS = {
    en: {
        ...
        emergency_108: "Ambulance: 108",
        emergency_112: "Emergency: 112",
    ...
    hi: {
        ...
        header_tagline: "डॉक्टर तक सीधा रास्ता | प्रे्डिक्ट. कनेक्ट. केयर",
        ...
        footer_desc: "ग्रामीण भारत को विशेषज्ञ स्वास्थ्य सेवा से जोड़ना। लक्षणों का अनुमान लगाएं, डॉक्टर खोजें और तुरंत प्राथमिक चिकित्सा प्राप्त करें।",
        footer_quick: "त्वरित संपर्क",
        ...
        emergency_108: "एम्बुलेंस: 108",
        emergency_112: "आपातकालीन: 112",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateLanguage() {
        if (TRANSLATIONS[currentLang].brand_name) {
            const ruralHealthAssistantText = currentLang === 'hi' ? 'ग्रामीण स्वास्थ्य सहायक' : 'Rural Health Assistant';
            document.title = TRANSLATIONS[currentLang].brand_name + " | " + ruralHealthAssistantText;
        }
        ...
        DOCTORS.forEach(doc => {
            ...
            card.innerHTML = `
                <div class="card-header">
                    ...
                    <div class="dist-badge">${doc.distance}</div>
                </div>
                <p>${currentLang === 'hi' ? doc.specialization_hi : doc.specialization}</p>
                <div class="doc-info-grid">
                    <div class="doc-info-item">
                        <span class="info-label">${TRANSLATIONS[currentLang].label_wait_time}:</span>
                        <span class="info-value">${doc.wait_time}</span>
                    </div>
                    <div class="doc-info-item">
                        <span class="info-label">${TRANSLATIONS[currentLang].label_consultation}:</span>
                        <span class="info-value">${doc.fee === "0" ? TRANSLATIONS[currentLang].free_text : TRANSLATIONS[currentLang].currency_symbol + doc.fee}</span>
                    </div>
                </div>
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (e) => {
            ...
            alert(currentLang === 'hi' ? `ओटीपी ${mobile} पर भेजा गया (डिफ़ॉल्ट: 1234)` : `OTP sent to ${mobile} (Default: 1234)`);
        ...
        if (verifyBtn) {
            verifyBtn.addEventListener('click', () => {
                ...
                if (otpInput === '1234') {
                    alert(currentLang === 'hi' ? 'लॉगिन सफल!' : 'Login Successful!');
                    ...
                    alert(currentLang === 'hi' ? 'अमान्य ओटीपी' : 'Invalid OTP');
                }
            });
        }
    }
    ...
    function checkAuth() {
        ...
        if (headerWelcome) {
            const welcomeText = currentLang === 'hi' ? 'नमस्ते, ' : 'Welcome, ';
            headerWelcome.textContent = welcomeText + userName;
        }
    ...
    if (logoutBtn) {
        logoutBtn.addEventListener('click', () => {
            ...
            alert(currentLang === 'hi' ? 'सफलतापूर्वक लॉग आउट किया गया' : 'Logged out successfully');
            window.location.href = 'index.html';
        });
    }
